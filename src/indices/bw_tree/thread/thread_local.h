...
public:
     ...
     * Constructor
     */
    GarbageNode(EpochType p_delete_epoch, void *p_ptr) : delete_epoch{p_delete_epoch}, ptr{p_ptr} {}
...
public:
     ...
     * Constructor
     */
    GarbageGroup() : node_count{0}, next_p{nullptr}, garbage_node_list{} {}
     ...
     */
    inline bool IsEmpty() const { return node_count == 0; }
