...
const char *BwTreeBase::GCMetaData::COUNTER_NAME_LIST[] = {
    "INSERT",       "UPSERT",        "DELETE",     "READ",

    "LEAF_SPLIT",   "INNER_SPLIT",   "LEAF_MERGE", "INNER_MERGE", "LEAF_CONSOLIDATE", "INNER_CONSOLIDATE",

    "MODIFY_ABORT", "READ_ABORT",

    "ADD_TO_GC",    "SCAN_GC_CHAIN",
};
#endif
