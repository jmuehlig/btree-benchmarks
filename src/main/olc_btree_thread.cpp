...
#include <indices/olc_btree/thread/thread_benchmark.h>
...
int main(int count_arguments, const char **arguments)
{
    ...
    indices::optimistic_btree::thread::ThreadBenchmark thread_benchmark(cli_arguments);
    thread_benchmark.execute();
